  ...
  return (
    <div>
      ...
      >
        ...
        <div className="box-container overflow-auto">
          {feedbacks.map((feedback) => {
            ...
            return (
              <div class="box">
                ...
                <p class="text">
                  <br></br>
                  During my testing, I said "Tatakae" and I encountered no
                  glitches, crashes, or performance issues. The application
                  responded promptly to commands, and data syncing across
                  devices was seamless. The developers seem to have invested in
                  optimizing performance, resulting in a reliable and stable
                  platform.
                </p>
              </div>
            );
          ...
          {/* <div class="box">
            ...
            <p class="text">
              <br></br>
              During my testing, I said "Tatakae" and I encountered no glitches,
              crashes, or performance issues. The application responded promptly
              to commands, and data syncing across devices was seamless. The
          ...
          <div class="box">
            ...
            <p class="text">
              <br></br>I recently had the opportunity to explore Symptomata, and
              I am thoroughly impressed with its functionality, user interface,
              and overall performance. As a user with diverse needs, I found
              that the application excelled in several key areas. Ereeeh!
            </p>
          </div>
          <div class="box">
            <img src="Images/S3.gif" alt="" />
