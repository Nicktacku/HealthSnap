...
function App() {
  return (
    <div className="App">
      ...
      <header class="header">
		<a href="#" class="logo"> <img src="Images\SLogo.png"/></a>
...
{/*!--icons section starts*/}
    ...
    <section class="aboutus" id="aboutus">
        ...
        <div class="content">
            ...
            <p>This application was created by programmers with a mission to empower individuals in taking control of their well-being. The platform offers a holistic approach to health, integrating cutting-edge technology like artificial intelligence, wearables, and Non-Deterministic Finite Automata. With a user-friendly interface, it provides personalized insights, social support, and real-time recommendations for a balanced lifestyle. The developers strive to keep the platform responsive to evolving health trends, ensuring its continued relevance and effectiveness in promoting a healthier and happier community.</p>
            <a href="#book" class="btn"> Learn More <FontAwesomeIcon icon={faChevronRight} /></a>
...
<section class="doctors" id="doctors">
	...
	<h1 class="heading"> HEALTH SNAP <span> DEVELOPERS </span> </h1>
...
<section class="review" id="review">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p class="text">I recently had the opportunity to explore Symptomata, and I am thoroughly impressed with its functionality, user interface, and overall performance. As a user with diverse needs, I found that the application excelled in several key areas.</p>
        </div>
        <div class="box">
            <img src="Images/S3.gif" alt=""/>
            <h3>Justin Santos</h3>
            ...
            <p class="text">One of the standout features of Symptomata is its intuitive and user-friendly interface. Navigating through the various sections is a breeze, and the well-designed layout ensures that users can quickly access the features they need. The sleek design contributes to an enjoyable user experience, making it accessible for users of all technical abilities.</p>
        </div>
        <div class="box">
              <img src="Images/S3.gif" alt=""/>
              <h3>Your review</h3>
              ...
              <a href="feedback.html" class="btn">ADD FEEDBACK <FontAwesomeIcon icon={faPlus}/>
...
<section class="footer">
	...
	<div class="box-container">
		...
		<div class="box">
			<h3>Contact Us</h3>
			<a href="#"> <FontAwesomeIcon icon={faChevronRight}/> +123-456-7890</a>
			<a href="#"> <FontAwesomeIcon icon={faChevronRight}/> +639-456-7890</a>
			<a href="#"> <FontAwesomeIcon icon={faChevronRight}/> meow@gmail.com</a>
			<a href="#"> <FontAwesomeIcon icon={faChevronRight}/> Philippines</a>
